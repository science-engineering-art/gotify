...
var file_kademlia_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x22, 0x43, 0x0a, 0x09, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12,
	0x10, 0x0a, 0x03, 0x4b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x4b, 0x65,
	0x79, 0x12, 0x24, 0x0a, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0e, 0x2e, 0x6b, 0x61, 0x64, 0x65, 0x6d, 0x6c, 0x69, 0x61, 0x2e, 0x44, 0x61, 0x74, 0x61,
	0x52, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x1a, 0x0a, 0x08, 0x54, 0x61, 0x72, 0x67, 0x65,
	0x74, 0x49, 0x44, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52,
...
var file_kademlia_proto_depIdxs = []int32{
	2, // 0: kademlia.StoreData.Value:type_name -> kademlia.Data
	1, // 1: kademlia.KBucket.Bucket:type_name -> kademlia.Node
	5, // 2: kademlia.FindValueResponse.KNeartestBuckets:type_name -> kademlia.KBucket
	2, // 3: kademlia.FindValueResponse.Value:type_name -> kademlia.Data
	1, // 4: kademlia.FullNode.Ping:input_type -> kademlia.Node
	3, // 5: kademlia.FullNode.Store:input_type -> kademlia.StoreData
	4, // 6: kademlia.FullNode.FindNode:input_type -> kademlia.TargetID
	4, // 7: kademlia.FullNode.FindValue:input_type -> kademlia.TargetID
	1, // 8: kademlia.FullNode.Ping:output_type -> kademlia.Node
	0, // 9: kademlia.FullNode.Store:output_type -> kademlia.Response
	5, // 10: kademlia.FullNode.FindNode:output_type -> kademlia.KBucket
	6, // 11: kademlia.FullNode.FindValue:output_type -> kademlia.FindValueResponse
